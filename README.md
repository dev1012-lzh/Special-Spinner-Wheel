...
1. For `embed_supoort.html`, the page is optimized for presentations embed like Canva and Slides from Google - FOR PRANK USES ONLY. However array must changed to designated numbers via FORKING this file.
